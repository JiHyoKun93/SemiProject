...
<title>${customInfo.userName}님의 계좌 보기</title>
			...
			<div id=pageHeader>
				...
				<ul id="menu">
					...
					<c:if test="${not empty customInfo}">
						...
						<li class="menu_item1"><a href="<%=cp%>/eggplant/board.do" class="link">고객 센터</a></li>
						<li class="menu_item1"><a href="<%=cp%>/eggplant/map.do" class="link">오시는 길</a></li>
						<li class="menu_item3">${customInfo.userName}님환영합니다.</li>
				...
				<div style="text-align: center;">
						...
						<tr>
							<div style="padding: 0px;">
								...
								<td align="right" width="100">
									<font color="blue" style="font-size: 20pt; font-family: 'NanumSquareExtraBold';">${sessionScope.customInfo.userName }</font>
								</td>
								<td align="left">
									<font color="#8B95A1" style="font-size: 20pt; font-family: 'NanumSquareAcr';">&nbsp;님</font>
								</td>
							</div>
						</tr>
					</table>
					...
					<c:choose>
						...
						<c:when test="${lists.size()==0 }">
							<font size="3pt" style="font-family: 'NanumSquareAcr';"> <br />
							<br />
							<br />
							<br />등록된 계좌가 없습니다.
							</font>
						...
						<c:otherwise>
							<c:forEach var="dto" items="${lists }">
								...
								<table border="0" bordercolor="black" width="450" height="80" cellpadding="0" cellspacing="0" style="margin: auto;">
									...
									<tr>
										<td align="left" valign="bottom">
											<font color="blue" style="font-size: 15pt; font-family: 'NanumSquareAcr';">${dto.account }</font>
										</td>
										<td align="right" valign="bottom">

											<input type="button" value="거래내역" class="eggButton" ;
						onclick="searchAccount();" />

											<input type="button" value="이체" class="eggButton" ;
						onclick="reservation();" />

											<input type="hidden" name="userName" value="${sessionScope.customInfo.userName }" />
											<input type="hidden" name="userAccount" value="${dto.account }" />
										</td>
									</tr>
									<tr>
