...
<script type="text/javascript">
  ...
  <title>EGGPPLANT BANK 카드혜택</title>
    <link rel="canonical" href="https://codepen.io/creativeocean/pen/oNzjEYj">
...
<body translate="no">
	...
	<table border="1" cellpadding="0" cellspacing="0">
		<tr>
			<td width="600" bgcolor="#000000" style="font-family: NanumSquareAceb; font-size: 30px; color: #fff; padding-top: 40px; font-weight: bold;" height="60" align="center">
			 'EGGPLANT BANK만의 특별한 카드혜택!'
			</td>
		</tr>
  ...
  <defs>
    ...
    <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="65%">
      <stop offset="10%" stop-color="#004476"></stop>
      <stop offset="90%" stop-color="#006fbe"></stop>
    </linearGradient>
    <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="85%">
      <stop offset="0%" stop-color="#f5eacc"></stop>
      <stop offset="80%" stop-color="#e0c677"></stop>
      <stop offset="110%" stop-color="#ebd8a0"></stop>      
    </linearGradient>
    <linearGradient id="grad3" x1="0%" y1="0%" x2="100%" y2="85%">
      <stop offset="0%" stop-color="#54e2fe"></stop>
      <stop offset="80%" stop-color="#049afd"></stop>
      <stop offset="110%" stop-color="#2aaffc"></stop>      
    </linearGradient>
    <linearGradient id="grad4" x1="0%" y1="0%" x2="80%" y2="70%">
      <stop offset="0%" stop-color="rgba(255,255,255,0.75)"></stop>
      <stop offset="90%" stop-color="rgba(255,255,255,0.3)"></stop>
    </linearGradient>
    
    <pattern id="cardBg" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
      <image opacity="0.5" width="100" height="100" xlink:href="https://assets.codepen.io/721952/whiteNoise2.png"></image>
      <image class="fillLight" opacity="0.5" width="100" height="100" xlink:href="https://assets.codepen.io/721952/whiteNoise.png" style="opacity: 0.1283;"></image>
    </pattern>
      
    <mask id="m">
      <rect class="card" fill="#fff" width="340" height="540" rx="30" ry="30" data-svg-origin="170 270" style="transform-origin: 0px 0px; opacity: 1;" transform="matrix(0.99969,0.02483,-0.02483,0.99969,206.7568,35.8626)"></rect>
    </mask>
    
  </defs>
  
  <rect fill="url(#grad1)" width="100%" height="100%"></rect>
  
  <g class="main" data-svg-origin="-10 -25.555557250976562" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,-41.5,159)">
  
  <font style="color: #fff; size: 50pt;"> EGGPLANT BANK 카드혜택</font>
  
  
    <circle class="ball bg" fill="url(#grad2)" cx="120" cy="130" r="130" data-svg-origin="120 130" style="transform-origin: 0px 0px; opacity: 1;" transform="matrix(1,0,0,1,-87.172,-15.3042)"></circle>
    <circle class="ball bg" fill="url(#grad3)" cx="550" cy="410" r="210" data-svg-origin="550 410" style="transform-origin: 0px 0px; opacity: 1;" transform="matrix(1,0,0,1,-87.172,-15.3042)"></circle>
    <g class="blur" mask="url(#m)">
      <image class="bg" x="33" y="7" width="700" height="600" xlink:href="https://assets.codepen.io/721952/bgBlur.jpg" data-svg-origin="33 7" transform="matrix(1,0,0,1,-87.172,-15.3042)" style="transform-origin: 0px 0px;"></image>
    </g>
    <g class="card" data-svg-origin="170.5 270.5" style="transform-origin: 0px 0px; opacity: 1;" transform="matrix(0.99969,0.02483,-0.02483,0.99969,206.76937,35.85034)">
      <rect fill="none" stroke="#ccc" opacity="0.75" stroke-width="3" width="341" height="541" rx="31" ry="31"></rect>
      <rect fill="url(#cardBg)" width="340" height="540" rx="30" ry="30" opacity="0.8"></rect>
      <text class="numTxt" fill="#f0f0f0" font-size="23" data-svg-origin="0 -25.87936782836914" transform="matrix(1,0,0,1,22,375)" style="transform-origin: 0px 0px;">1111 2222 3333 4444</text>
      <text class="nameTxt" fill="#e4e4f4" font-size="15" data-svg-origin="0 -17.06937026977539" transform="matrix(1,0,0,1,22,410)" style="transform-origin: 0px 0px;">EGGPLANT BANK</text>      
      <g class="chip" data-svg-origin="0 0" transform="matrix(1,0,0,1,148,66)" style="transform-origin: 0px 0px;">
        <rect fill="url(#grad2)" width="58" height="76.5" rx="9" ry="9"></rect>
...
<table width="600" border="1" cellspacing="0" cellpadding="0" style="position: fixed; bottom: 1px;" >
	<tr>
  ...
  <tr>
    <td align="center" height="30" width="600" bgcolor="#fff">
        <input type="checkbox" name="popup" value="no"/><font color="#555555" style="
font-family: NanumSquareAceb; "> 오늘 하루동안 이 창을 열지 않음</font>
        <input type="hidden" name="win" value="yes"/>
    </td>
    <td height="28" align="right" width="40" bgcolor="#fff">
        <a href="#" onclick="sendIt();"><i class="fa-regular fa-rectangle-xmark fa-bounce fa-2xl" style="color: #000000; padding-right: 20px;"></i></a>&nbsp;&nbsp;
    </td>
  </tr>
</table>
</form>
