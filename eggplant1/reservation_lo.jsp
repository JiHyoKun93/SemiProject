...
<input type="hidden" name="targetBank" value="${targetBank }"/>
<input type="hidden" name="targetName" value="${targetName }"/>
<input type="hidden" name="targetAccount" value="${targetAccount }"/>
<input type="hidden" name="userPwd" value="${userPwd }"/>
<input type="hidden" name="sendSaving" value="${sendSaving }"/>
...
function redirectToOtherPage() {
	...
	f = document.myForm;
	f.action = "<%=cp%>/eggplant/reservation_ck.do"
	f.submit();
  }
